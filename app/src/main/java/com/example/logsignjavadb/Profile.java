...
public class Profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name_P.setText(sp.getString(ConstatSP.name,null));
        email_P.setText(sp.getString(ConstatSP.email,null));
        contact_P.setText(sp.getString(ConstatSP.contact,null));
        password_P.setText(sp.getString(ConstatSP.password,null));

//        Log.d("NAME_DEBUG", sp.getString("NAME",null));
